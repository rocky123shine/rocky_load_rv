package com.rocky.rockyloadrv.load_rv;
 ...
 */
public class RockyLoadAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public RockyLoadAdapter(RecyclerView.Adapter adapter, LoadRvFooter mFooterView, boolean mEnablePullLoad) {
